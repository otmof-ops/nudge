...
@test "network_handle_offline skip returns EXIT_NETWORK_FAIL" {
    OFFLINE_MODE="skip"
    run network_handle_offline
    [[ "$status" -eq "$EXIT_NETWORK_FAIL" ]]
}

@test "network_handle_offline notify calls notify-send" {
