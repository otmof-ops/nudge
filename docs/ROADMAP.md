...
| Field | Value |
|---|---|
| **Document ID** | OTM-NUDGE-ROADMAP-001/2026 |
...
|-------|-------------|--------|--------|
| Phase 1 | Basic KDE update prompt (v1.0) | 2026-Q1 | Complete |
| Phase 2 | Multi-desktop + enhanced installer (v1.1) | 2026-Q1 | Complete |
| Phase 3 | Enterprise-grade modular architecture (v2.0) | 2026-Q1 | Complete |
...
- **31 configuration keys** (up from 11)
